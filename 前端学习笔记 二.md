...
### 1. 使用 CSS Transform scale 属性可以更改元素的大小
...
![](D:\CS science\study note\元素素材\渐变比例 1.png)

### 2. 使用CSS Transform scale 属性在悬停时缩放元素
...
### 3. 使用 CSS Transform skex 属性沿X轴倾斜元素
...
<img src="D:\CS science\study note\元素素材\transform skex.png" style="zoom:67%;" />

### 4 使用 CSS Transform skex 属性沿Y轴倾斜元素
...
<img src="D:\CS science\study note\元素素材\transform skewY.png" style="zoom:67%;" />
...
![](D:\CS science\study note\元素素材\绘图0、.png)

![](D:\CS science\study note\元素素材\绘图1.png)

### 6. 使用 CSS 和 HTML 创建更复杂的形状
...
### **第六节 创建动画**`@keyframes name`

### 1. 了解 CSS 的关键帧和动画是如何工作的
